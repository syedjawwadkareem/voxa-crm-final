    ...
    <div>
      ...
      <div className="px-6 py-6">
        {canReadUsers ? (
          ...
          <div className="card p-8 text-center max-w-xl mx-auto border border-slate-200">
            <div className="w-14 h-14 rounded-2xl bg-indigo-50 flex items-center justify-center mx-auto mb-4">
              <UserCircle size={28} className="text-indigo-600" />
            </div>
            <h2 className="text-lg font-bold text-slate-800 mb-1">Company Workspace</h2>
            <p className="text-slate-500 text-sm mb-6">
              You are logged in with role-restricted access. Select an authorized module from the sidebar navigation to get started.
            </p>
            <div className="flex flex-wrap items-center justify-center gap-3">
              {hasPermission('calls:read') && (
                <a href="/company/logs" className="btn-outline text-xs px-4 py-2 inline-flex items-center gap-1.5">
                  <FileText size={14} /> Call Logs
                </a>
              )}
            </div>
          </div>
